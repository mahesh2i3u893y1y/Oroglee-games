...
const ReorderActivity = () => {
  const questions = [
    ...
    { situation: "Egg to Bird", items: ["🥚", "🪹", "🐦"], correctOrder: ["🥚", "🪹", "🐦"] },
    { situation: "Wood to Fire", items: ["🪵", "🔥", "💨"], correctOrder: ["🪵", "🔥", "💨"] },
    { situation: "Sun to Solar Energy", items: ["☀️", "🔋", "💡"], correctOrder: ["☀️", "🔋", "💡"] },
    { situation: "Milk to Cheese", items: ["🥛", "🍶", "🧀"], correctOrder: ["🥛", "🍶", "🧀"] },
  ];
